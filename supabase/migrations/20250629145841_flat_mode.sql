/*
  # Survey Payment System

  1. New Tables
    - `survey_subscriptions`
      - `id` (uuid, primary key)
      - `user_id` (uuid, references user_profiles.id)
      - `plan_id` (text, not null) - Plan identifier (single, small, medium, large, xlarge, xxlarge, enterprise)
  ...
  3. Functions
    ...
    - Helper functions for survey subscription management
*/
